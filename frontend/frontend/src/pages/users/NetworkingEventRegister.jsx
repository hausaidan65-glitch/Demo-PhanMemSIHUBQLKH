...
export default function NetworkingEventRegister() {
  const { id } = useParams();
  ...
  useEffect(() => {
    const loadEvent = async () => {
      try {
        ...
        const response = await axios.get(`${API_URL}/networking-events/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_URL}/networking-events/${id}/register`,
        {
