...
class NetworkingEventProgressModel {
  ...
  static progressSelectSql() {
    return `
      ...
      FROM networking_event_progress_reports progress
  ...
  static async createProgress({ eventId, content, note, createdBy }) {
    const [result] = await db.query(
      `
      INSERT INTO networking_event_progress_reports
...
module.exports = NetworkingEventProgressModel;
